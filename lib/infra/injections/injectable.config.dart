...
import '../../data/repository/get_weather_status_repository_impl.dart' as _i10;
import '../../data/usecase/get_location_usecase_impl.dart' as _i8;
import '../../data/usecase/get_weather_usecase_impl.dart' as _i12;
...
import '../../domain/repository/get_weather_status_repository.dart' as _i9;
import '../../domain/usecase/get_location_usecase.dart' as _i7;
import '../../domain/usecase/get_weather_usecase.dart' as _i11;
import '../../presentation/pages/homePage/home_page_controller.dart' as _i13;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i9.GetWeatherStatusRepository>(
        () => _i10.GetWeatherStatusRepositoryImpl());
    gh.factory<_i11.GetWeatherUsecase>(() => _i12.GetWeatherUsecaseImpl(
          getLocationRepository: gh<_i5.GetLocationRepository>(),
          getAirQualityRepository: gh<_i3.GetAirQualityRepository>(),
          getWeatherStatusRepository: gh<_i9.GetWeatherStatusRepository>(),
        ));
    gh.factory<_i13.HomePageController>(() => _i13.HomePageController(
        getWeatherUsecase: gh<_i11.GetWeatherUsecase>()));
    return this;
  }
}
